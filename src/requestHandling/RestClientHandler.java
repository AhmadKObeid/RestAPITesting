...
public class RestClientHandler {
     ...
     */
    public static HttpURLConnection connectServer(String Url, String method, HTTPRequestsContentTypes contentType) throws IOException {
        URL url = new URL(Url);
    ...
    public static void sendPost(HttpURLConnection conn, HTTPRequestsContentTypes contentType) throws Exception {
        try {
